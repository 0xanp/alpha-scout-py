...
class MessageHandler:
    ...
    def url_match(self, url: str) -> str:
        match = re.search(r'(http(s)?:\/\/.)?(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)', url)
        if match:
    ...
    def is_twitter_status(self, message: str) -> bool:
        pattern = r"^(https://twitter.com/|https://mobile.twitter.com/|https://x.com/|https://mobile.x.com/)(\w+)/status/*"
